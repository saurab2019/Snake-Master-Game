...
public class Board extends JPanel implements ActionListener {
    ...
    public void gameOver(Graphics g) {
        ...
        String scoreMsg = " Your score is " + appleEaten;
        ...
        g.drawString(scoreMsg, (300 - metrices.stringWidth(scoreMsg)) / 2, 336/2);
    }
    ...
    public void checkApple() {
        if ((x[0] == apple_x) && (y[0] == apple_y)) {
            dots++;
            appleEaten++;
            speedPhase = Math.min(3, appleEaten/5);
            timer.setDelay(140 - speedPhase * 20);
            locateApple();
        }
    }
